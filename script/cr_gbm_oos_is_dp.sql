--
-- cr_gbm_oos_is_dp.sql
--

-- Demo:
-- ./psqlmad.bash -f cr_gbm_oos_is.sql -v dayspast=$DAYSPAST
-- or
-- ./psqlmad.bash -f cr_gbm_oos_is.sql -v dayspast=30

-- This script is called by:
-- ~/spy611/script/pred_gbm.bash
-- ~/spy611/script/cr_gbm_oos_is_dp.bash
