--
-- ~/spy611/script/backtests/rpt_ip_lr.sql
--

-- Demo:
-- ~/spy611/script/psqlhtml.bash -f rpt_ip_lr.sql -v ng=n1dg
-- ~/spy611/script/psqlmad.bash  -f rpt_ip_lr.sql -v ng=n1dg

-- I use this script to generate an html report

DROP TABLE IF EXISTS bt_lr_:ng;
CREATE TABLE bt_lr_:ng AS SELECT * FROM ip_:ng WHERE algo = 'lr';
...
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_lr_:ng WHERE prob_willbetrue < 0.48;
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_lr_:ng WHERE prob_willbetrue < 0.50;
-- 
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_lr_:ng;
-- 
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_lr_:ng WHERE prob_willbetrue >= 0.50;
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_lr_:ng WHERE prob_willbetrue > 0.52;
