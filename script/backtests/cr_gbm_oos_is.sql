--
-- ~/spy611/script/backtests/cr_gbm_oos_is.sql
--

-- Demo:
-- ./psqlmad.bash -f cr_gbm_oos_is.sql -v yr="'$YR'"
-- or
-- ./psqlmad.bash -f cr_gbm_oos_is.sql -v yr="'2010'"

-- This script is called by cr_gbm_oos_is.bash
-- Which is called by
...
SELECT MIN(ydate), COUNT(ydate), MAX(ydate) FROM gbm_track;
