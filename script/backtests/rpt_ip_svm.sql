--
-- ~/spy611/script/backtests/rpt_ip_svm.sql
--

-- Demo:
-- ~/spy611/script/psqlhtml.bash -f rpt_ip_svm.sql -v ng=n1dg
-- ~/spy611/script/psqlmad.bash  -f rpt_ip_svm.sql -v ng=n1dg

-- I use this script to generate an html report

DROP TABLE IF EXISTS bt_svm_:ng;
CREATE TABLE bt_svm_:ng AS SELECT * FROM ip_:ng WHERE algo = 'svm';
...
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_svm_:ng WHERE prob_willbetrue < 0.48;
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_svm_:ng WHERE prob_willbetrue < 0.50;
-- 
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_svm_:ng;
-- 
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_svm_:ng WHERE prob_willbetrue >= 0.50;
-- SELECT COUNT(pctgain),AVG(pctgain) FROM bt_svm_:ng WHERE prob_willbetrue > 0.52;
