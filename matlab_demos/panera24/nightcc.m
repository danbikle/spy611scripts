% /a/ks/b/matlab/panera24/nightcc.m

% I use this script to now issue close to close predictions at night.
...
night_prdctns = nxt_prdctns(:,{'ydatestr','cp','upprob1d','upprob2d','upprob1w','nxt_prob1d','nxt_prob2d','nxt_prob1w'});
mynowstr = nowstr();
fname = strcat('data/night_prdctns_', mynowstr, '.csv');
writetable(night_prdctns,fname);
writetable(night_prdctns,'data/night_prdctns.csv');
